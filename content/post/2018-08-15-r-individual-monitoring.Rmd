...
![](/post/3-Individual_Monitoring/bender.jpg)
...
![](/post/3-Individual_Monitoring/quality-control.jpg)
...
It's always easier to understand this stuff with visuals. If you'd like to follow along, the data can be found [here](/post/3-Individual_Monitoring/jump-data.csv). Let's see what we're working with:
